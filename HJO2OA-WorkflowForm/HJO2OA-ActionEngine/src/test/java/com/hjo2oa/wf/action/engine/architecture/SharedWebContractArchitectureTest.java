package com.hjo2oa.wf.action.engine.architecture;
...
@AnalyzeClasses(packages = "com.hjo2oa.wf.action.engine", importOptions = ImportOption.DoNotIncludeTests.class)
