package com.hjo2oa.wf.form.renderer.architecture;
...
@AnalyzeClasses(packages = "com.hjo2oa.wf.form.renderer", importOptions = ImportOption.DoNotIncludeTests.class)
