...
@Mapper
interface ServiceVersionRecordMapper extends BaseMapper<ServiceVersionRecordEntity>, DataServicesMapper {

    @InterceptorIgnore(tenantLine = "true")
    @Delete("DELETE FROM dbo.data_service_version_record WHERE governance_id = #{governanceId}")
