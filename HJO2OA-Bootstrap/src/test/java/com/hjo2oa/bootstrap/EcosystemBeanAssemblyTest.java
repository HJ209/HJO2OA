...
class EcosystemBeanAssemblyTest {
    ...
    @MockBean
    private EcosystemIntegrationMapper ecosystemIntegrationMapper;

    @MockBean
    private CallbackAuditRecordMapper callbackAuditRecordMapper;
